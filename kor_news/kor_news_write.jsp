...
<script language="javascript">
	...
	function GoList()
	{
		...
		document.location = "kor_news.jsp";
	}
...
<!----------------------------------------------내용부-------------------------------------------------->	
<form id="write_form" name="write_form" method="post" action="kor_news_write_ok.jsp">	
	<input type="hidden" id="key" name="key" value="<%= key %>">
	<input type="hidden" id="pageno" name="pageno" value="<%= pageno %>">
	<table border="1" width="100" height="150" align="center">
		<tr>
			<td>
				<input type="text" id="writer" name="writer" size="24" placeholder="닉네임을 입력하세요.">
			</td>
		</tr>
		<tr>
			<td>
