...
mInsertSQL += "values ('" + writer + "','" + pw + "','" + title + "','" + content + "','" + date + "','" + "B" + "','" + "K" + "',0,'"+link+"')";
...
//뉴스게시판 목록으로 이동
	function GoList()
	{
		document.location = "kor_news.jsp?pageno=<%= pageno %>";
	}
	...
	<input type="hidden" id="pageno" name="pageno" value="<%= pageno %>">
		...
		<tr>
			<td align="center" height="30">
				...
				<input type="button" value="내용 보기" onClick="location.href='kor_news_view.jsp?no=<%= no %>';">	
			</td>
		</tr>
</table>
