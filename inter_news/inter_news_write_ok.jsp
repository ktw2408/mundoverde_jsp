...
<%
//========== inter_news_write.jsp 에서 보내준 정보를 분석한다.
//목록에서 넘겨준 파라메터를 분석한다.
...
String date      = "";								//게시물 등록일
String link      = request.getParameter("link");	//뉴스링크
...
mInsertSQL += "(writer,pw,title,content,date,type,league,hit,link) ";
mInsertSQL += "values ('" + writer + "','" + pw + "','" + title + "','" + content + "','" + date + "','" + "B" + "','" + "I" + "',0,'"+link+"')";
...
//뉴스게시판 목록으로 이동
	function GoList()
	{
		document.location = "inter_news.jsp?pageno=<%= pageno %>";
	}
	...
	<input type="hidden" id="pageno" name="pageno" value="<%= pageno %>">
		...
		<tr>
			<td align="center" height="30">
				...
				<input type="button" value="내용 보기" onClick="location.href='inter_news_view.jsp?no=<%= no %>';">	
			</td>
		</tr>
</table>
