...
//게시물 수정
	function modifyArticle(){		
			...
			window.open("agora_modify_ask.jsp?pageno=<%= pageno %>&no=<%= no %>","_modify","width=300,height=400");
			
	}
	//게시물 삭제
	function delArticle()
	{		
		window.open("agora_delete.jsp?no=<%= no %>","_delete","width=300,height=400");
	}
	//목록으로 이동
	function GoList()
	{
		document.location = "agoraMain.jsp?key=<%= key %>&pageno=<%= pageno %>";
	}

</script>
<table border="1" width="50%" align="center">
<tr>		
		<td align="center">번호 : <%= board_no %></td>
	</tr>
	<tr>		
	...
	<tr>
		<td align="center">날짜 : <%= board_date %></td>		
	</tr>
	<tr>
...
<%@ include file="../include/agora_reply.jsp" %>	
</table>
