...
<%
//========== agora_write.jsp 에서 보내준 정보를 분석한다.
//목록에서 넘겨준 파라메터를 분석한다.
...
mInsertSQL += "(writer,pw,title,content,date,type,hit) ";
mInsertSQL += "values ('" + writer + "','" + pw + "','" + title + "','" + content + "','" + date + "','" + "D" + "',0)";
...
<table border="1" cellpadding="0" cellspacing="0" bgcolor="#fffff0" width="90%">
		...
		<tr>
			<td align="center" height="30">
				...
				<input type="button" value="내용 보기" onClick="location.href='agora_view.jsp?no=<%= no %>'">
			</td>
		</tr>
</table>
