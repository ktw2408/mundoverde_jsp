...
mSelectSQL += "select no,writer,pw,title,content,date,type,league,hit ";
...
<script language="javascript">
	...
	function GoList()
	{
		if(confirm("수정을 취소하고 게시물로 이동하시겠습니까?") != 1)
		{
			return;
		}
		document.location = "agora_view.jsp?pageno=<%= pageno %>&no=<%= no %>";
	}
		//수정하기를 누르면 호출되는 함수
	function FormCheck()
	{		
...
<form id="modify_form" name="modify_form" method="post" action="agora_modify_ok.jsp">	
