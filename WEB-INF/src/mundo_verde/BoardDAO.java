...
public class BoardDAO 
{
    ...
    public int getSeq()
    {
        ...
        try {
            ...
            sql.append("SELECT no.NEXTVAL FROM DUAL");
    ...
    public boolean boardInsert(BoardBean board)
    {
        ...
        try {
            ...
            sql.append("(no, BOARD_ID, BOARD_SUBJECT, BOARD_CONTENT, BOARD_FILE");
    ...
    public ArrayList<BoardBean> getBoardList(HashMap<String, Object> listOpt)
    {
        ...
        try {
            ...
            if(opt == null)
            {
                ...
                sql.append("(select rownum rnum, no, BOARD_ID, BOARD_SUBJECT");
