...
<%
//========== inter_free.jsp 에서 보내준 정보를 분석한다.
//목록에서 넘겨준 파라메터를 분석한다.
...
<script language="javascript">
	...
	function GoList()
	{
		...
		document.location = "inter_free.jsp";
	}
...
<!----------------------------------------------내용부-------------------------------------------------->		
<form id="write_form" name="write_form" method="post" action="inter_write_ok.jsp">
	<input type="hidden" id="key" name="key" value="<%= key %>">
	<input type="hidden" id="pageno" name="pageno" value="<%= pageno %>">
	<table border="1" width="100" height="150" align="center">
		<tr>
			<td>
				<input type="text" id="id" name="writer" size="20" placeholder="닉네임을 입력하세요.">
			</td>
		</tr>
		<tr>
			<td>
				<input type="password" id="pw" name="pw" size="20" placeholder="비밀번호를 입력하세요.">
			</td>
		</tr>
			<td>
