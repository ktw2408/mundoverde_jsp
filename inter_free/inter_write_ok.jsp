...
<%
//========== inter_write.jsp 에서 보내준 정보를 분석한다.
//목록에서 넘겨준 파라메터를 분석한다.
...
mInsertSQL += "values ('" + writer + "','" + pw + "','" + title + "','" + content + "','" + date + "','" + "A" + "','" + "I" + "',0)";
...
<table border="1" cellpadding="0" cellspacing="0" bgcolor="#fffff0" width="90%">
		...
		<tr>
			<td align="center" height="30">
				[ <a href="inter_free.jsp?key=<%= key %>&pageno=<%= pageno %>">목록으로 이동</a> ]
				[ <a href="inter_view.jsp?no=<%= no %>">글내용 보기</a> ]
			</td>
		</tr>
</table>
